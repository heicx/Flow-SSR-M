  ...
  <div class="activity-detail">
    ...
    <div class="activity-content">
      <h3
        ...
        :class="{'active': activityItem.pushTop}"
        v-if="activityItem.name"
      >
        {{activityItem.name}}
      </h3>
      ...
      <h5 class="activity-desc" v-if="activityItem.address">
...
const actionItem = 'activity-review'

export default {
  layout: 'common',
  data() {
    return {
      headerActionItem: 'activity-review',
      headerItems: [
        {
          key: 'activity-recent',
          name: '近期活动',
